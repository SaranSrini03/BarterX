...
export default function NavBar() {
  ...
  return (
    <nav className="mx-auto m-5 flex justify-between items-center p-4 
    ...
    border border-black/20 text-white relative rounded-full  ">
      ...
      <div className="flex items-center gap-5">
        <div className="relative inline-block w-16 sm:w-20 group">
          <img src="/BarterxCoin.png" alt="BarterX Coin" className="w-full h-auto" />
